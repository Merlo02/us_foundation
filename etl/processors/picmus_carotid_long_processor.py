...
class PICMUSCarotidLongProcessor(BaseDatasetProcessor):
    """PICMUS carotid long: UFF (HDF5) container with channel data.

    Mirrors the reference extraction for this file family:
