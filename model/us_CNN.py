...
Input convention
---------------
- Training pipeline provides x with shape: (B, C, T)
    B = batch size
    C = num_transducers
...
This file removes global architecture constants and makes everything configurable via
filters / kernels / max_pools / dropout / head sizes.
"""
